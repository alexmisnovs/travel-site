...
var revealOnScrollFeatures = new _RevealOnScroll2.default(".feature-item", "85%");
var revealOnScrollTestimonials = new _RevealOnScroll2.default(".testimonial", "65%");
...
var RevealOnScroll = function () {
    ...
    function RevealOnScroll(className, offset) {
        ...
        this.itemsToReveal = (0, _jquery2.default)(className);
...
var StickyHeader = function () {
    function StickyHeader() {
        ...
        this.headerTriggerElement = (0, _jquery2.default)('.large-hero__description');
        ...
        value: function createHeaderWaypoints() {
            ...
            new Waypoint({
                ...
                handler: function handler(direction) {
                    ...
                    if (direction == "down") {
                        (0, _jquery2.default)(that.siteHeader).addClass("site-header--dark");
                    } else {
                        (0, _jquery2.default)(that.siteHeader).removeClass("site-header--dark");
                    }
                }
            });
        }
...
var Modal = function () {
    ...
    _createClass(Modal, [{
        ...
        value: function events() {
            ...
            //User pushes ESC key on the keyboard
            this.closeModalButton.click(this.closeModal.bind(this));

            //pushes any key not just ESC
